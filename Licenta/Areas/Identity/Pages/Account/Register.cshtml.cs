    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var fileName = Guid.NewGuid().ToString() + "_" + Input.ProfilePictureFile.FileName;
                ...
                {
                    user.ProfilePicture = "/images/profiles/default-profile.png"; // Asigură-te că ai această imagine în wwwroot
                }
