...
Generatorul de itinerariu construiește agenda fiecărei zile pe baza datei de început și de sfârșit, orei de explorare, rezervărilor existente și duratei medii de vizitare pentru fiecare locație. Algoritmul prioritizează evenimentele programate, apoi adaugă obiective disponibile din listă în ordinea proximității și a compatibilității cu intervalele orare. Lucrarea detaliază construirea modelelor de date relaționale, configurarea entităților many-to-many, validarea datelor și optimizarea fluxului de creare a itinerariului.

Rezultatul este o aplicație care sprijină utilizatorii în organizarea eficientă a traseelor turistice, a rezervărilor și planificarea responsabilă a zilelor de vizitare, oferind o experiență coerentă pe tot parcursul procesului.
\end{abstract}
